...
describe(
		...
		function() {
			...
			function makeHasPermission(permission) {
				element.append($compile(
						'<div class="my-class" has-permission="' + permission
			...
			it(
					'should leave the element if Subject have the specified permission',
					function() {
