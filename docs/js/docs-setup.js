NG_DOCS={
  ...
  "pages": [
    {
      "section": "api",
      "id": "angularShiro.directives.authenticated",
      "shortName": "angularShiro.directives.authenticated",
      "type": "directive",
    ...
    {
      "section": "api",
      "id": "angularShiro.directives.hasAnyRole",
    ...
    {
      "section": "api",
      "id": "angularShiro.directives.hasPermission",
    ...
    {
      "section": "api",
      "id": "angularShiro.directives.hasRole",
      "shortName": "angularShiro.directives.hasRole",
      "type": "directive",
      "moduleName": "angularShiro.directives",
      "shortDescription": "Display if the current Subject has the specified role (for example, ADMIN)",
      "keywords": "admin angularshiro api check current directive directives display example expression hasrole role subject"
    },
    {
      "section": "api",
      "id": "angularShiro.directives.lacksPermission",
    ...
    {
      "section": "api",
      "id": "angularShiro.directives.lacksRole",
    ...
    {
      "section": "api",
      "id": "angularShiro.directives.notAuthenticated",
      "shortName": "angularShiro.directives.notAuthenticated",
      "type": "directive",
      "moduleName": "angularShiro.directives",
      "shortDescription": "Display if the",
      "keywords": "angularshiro api authenticated current directive directives display notauthenticated session subject"
    },
    {
      "section": "api",
      "id": "angularShiro.directives.principal",
      "shortName": "angularShiro.directives.principal",
      "type": "directive",
      "moduleName": "angularShiro.directives",
      "shortDescription": "The principal directive will output the Subject&#39;s principal",
      "keywords": "$scope angular angularshiro api app attribute authc authenticationinfo authenticationresponseparser authorizer authz background baseline border-radius center color credentials css ctrl current data degas directive directives display edegas email example expose ffffff font-size font-weight function html infos injected injecting inline instance js line-height log login mock module ng-controller nowrap object output padding parse permissions principal process property purpose render repeat scope scroll setauthorizationinfo style subject text-align tojson var vertical-align white-space"
    },
    {
      "section": "api",
      "id": "angularShiro.directives.usernamePasswordForm",
      "shortName": "angularShiro.directives.usernamePasswordForm",
      "type": "directive",
      "moduleName": "angularShiro.directives",
      "shortDescription": "The usernamePasswordForm directive will display a",
      "keywords": "$scope alert angular-shiro angularshiro api app authentication based bootstrap built-in button connection ctrl custom default denied directive directives display documentation email error evaluate expression failure field form forms function html http integration js label labels latest login markup match mechanism message module mylabels ng-controller occured on-error onerror onsuccess password placeholder simple style submit successful username usernamepasswordform"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "ability access action angularshiro api argument behavior case casesensitive check comparison comparisons current described differents flag functionality implies indicating instance method multiple object part_divider_token parts perform permission property representing represents resource returns sensitive separate services string subpart_divider_token token tokens wildcard wildcard_token wildcardstring"
    },
    {
      "section": "api",
